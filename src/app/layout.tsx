...
export const metadata: Metadata = {
  title: "Elite Cosmetic Surgery - Expert Breast Augmentation",
  description: "Transform your confidence with personalized breast enhancement procedures by board-certified plastic surgeons. Schedule your consultation today.",
  keywords: "breast augmentation, plastic surgery, cosmetic surgery, breast enhancement, board certified surgeons",
  openGraph: {
    title: "Elite Cosmetic Surgery - Expert Breast Augmentation",
    description: "Transform your confidence with personalized breast enhancement procedures by board-certified plastic surgeons.",
    siteName: "Elite Cosmetic Surgery",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763394969132-zopusm5s.jpg",
      alt: "Professional plastic surgeon consultation"
    }]
  },
  twitter: {
    ...
    title: "Elite Cosmetic Surgery - Expert Breast Augmentation",
    description: "Transform your confidence with personalized breast enhancement procedures by board-certified plastic surgeons.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763394969132-zopusm5s.jpg"]
  },
  robots: {
    index: true,
    follow: true
